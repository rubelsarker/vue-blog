            ...
            <div class="navbar-header" data-logobg="skin5">
                ...
                <a class="navbar-brand" href="index.html">
                    ...
                    <span class="logo-text">
                             <!-- dark Logo text -->
                             <img src="{{url('')}}/asset/admin/assets/images/logo-text.png" alt="homepage" class="light-logo" />
            ...
            <nav class="sidebar-nav">
                <ul id="sidebarnav" class="p-t-30">
                    <li class="sidebar-item">
                        <router-link class="sidebar-link waves-effect waves-dark sidebar-link" to="/home" aria-expanded="false">
